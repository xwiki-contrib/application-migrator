...
/**
 * Define a fake migration descriptor implementing {@link AbstractMigrationDescriptor} that can then be used
 * in tests.
 *
 * @version $Id$
 * @since 1.0
 */
public class FakeMigrationDescriptor extends AbstractMigrationDescriptor
{
    /**
     ...
     */
    public FakeMigrationDescriptor(ExtensionId extensionId, String migrationName,
            String migrationDescription, MigrationParameters migrationParameters)
    {
