...
/**
 * Define a document migration descriptor. This class can be used in order to describe migrations that are related to
 * documents.
 *
 * @version $Id$
 * @since 1.0
 */
public class DocumentMigrationDescriptor extends AbstractMigrationDescriptor<DocumentMigrationType>
{
    /**
     * Builds a new {@link DocumentMigrationDescriptor}.
     *
     ...
     */
    public DocumentMigrationDescriptor(ExtensionId extensionId, String migrationName,
            String migrationDescription,
            MigrationParameters<? extends DocumentMigrationType> migrationParameters)
    {
